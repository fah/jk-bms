...
# ### THIS VERSION PRINTS A LIST OF THE CURRENT VALUES TO TERMINAL OUT 
# ### AND CREATES A FILE "JK_BMS.prom" IN THE LOCAL DIRECTORY WITH JUST THE CURRENT BMS VALUES
